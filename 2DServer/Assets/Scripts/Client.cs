...
public class Client
{
    ...
    public class TCP
    {
        ...
        private readonly int id;        //readonly as id will not change when connected
        ...
        {
            socket = _socket;                           //setting up the socket...
            ...
            stream.BeginRead(receiveBuffer, 0, dataBufferSize, ReceiveCallback, null);  //begin reading from the server
    ...
    public void SendIntoGame(string _playerName)
    {
        ...
        foreach (Client _client in Server.clients.Values)   //sends info of all current players to the new player
        {
        ...
        foreach (Client _client in Server.clients.Values)   //sends info about the new player to all other players
        {
            if (_client.player != null)
            {
